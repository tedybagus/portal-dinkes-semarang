    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h2 class="text-2xl font-bold text-gray-900">Tambah Menu</h2>
                    <p class="mt-1 text-sm text-gray-500">Buat menu navigasi baru</p>
                </div>
                <a href="{{ route('admin.menus.index') }}" class="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition">
                    ...
                    <form action="{{ route('admin.menus.store') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input 
                                ...
                                placeholder="Contoh: Dashboard, Artikel, Kategori"
                                required
                            >
                            @error('name')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                >
                                    ...
                                    <option value="super_admin" {{ old('role_slug') == 'super_admin' ? 'selected' : '' }}>Super Admin</option>
                                    <option value="author" {{ old('role_slug') == 'author' ? 'selected' : '' }}>Author</option>
                                    <option value="reviewer" {{ old('role_slug') == 'reviewer' ? 'selected' : '' }}>Reviewer</option>
                                </select>
                                @error('role_slug')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xs text-gray-500">
                                    <i class="fas fa-info-circle"></i> Pilih parent jika ini adalah sub-menu
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                >
                                <p class="mt-1 text-xs text-gray-500">
                                    <i class="fas fa-info-circle"></i> Angka kecil akan muncul lebih awal
                                </p>
                                @error('sort_order')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm text-blue-700">
                                        <strong>Tips:</strong> Menu yang tidak memiliki route (parent menu) akan otomatis dapat dibuka/tutup untuk menampilkan sub-menu.
                                    </p>
                                </div>
                            </div>
                        </div>
