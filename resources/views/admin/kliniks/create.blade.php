    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between mb-6">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">Tambahkan data kategori baru</p>
            </div>
    ...
    <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                ...
                <form action="{{ route('admin.kliniks.store') }}" method="POST" id="klinikForm">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input 
                                    ...
                                    placeholder="Contoh: Kategori Klinik"
                                    required
                                >
                                @error('nama')
                        ...
                        <div class="space-y-6">
                                ...
                                <div class="flex">
                                    ...
                                    <div class="ml-3">
                                        <p class="text-sm text-blue-700">
                                            <strong>Tips:</strong> Klik pada map di bawah untuk mengatur lokasi klinik. Koordinat akan otomatis terisi.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Search Location -->
                            <div>
                                <label for="searchLocation" class="block text-sm font-semibold text-gray-700 mb-2">
                                    Cari Lokasi
                                </label>
                                <div class="flex gap-2">
                                    <input 
                                        type="text" 
                                        id="searchLocation" 
                                        class="flex-1 px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition" 
                            ...
                            <div>
                                ...
                                <p class="mt-2 text-xs text-gray-500">
                                    <i class="fas fa-info-circle"></i> Klik pada map untuk menandai lokasi klinik atau drag marker
                                </p>
                            </div>
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    // Default location (Salatiga, Central Java)
...
async function searchLocation() {
    ...
    try {
        ...
        if (data && data.length > 0) {
            ...
            // Show popup with found location
