...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .dropdown-item:hover { background: #ffffff; color: var(--blue); padding-left: 1.2rem; }
        ...
        .btn-admin-login {
            ...
            color: var(--white) !important; /* ← !important untuk override */
        ...
        /* Hero stats bar */
        /* ============================================
   STATS SECTION - TERPISAH DARI HERO
   ============================================ */
.stats-section {
    background: #1e3a8a;
    padding: 2.5rem 0;
    margin-top: -1px; /* Hilangkan gap antara hero dan stats */
}
...
<div class="topbar">
    <div class="container">
        <div class="topbar-left">
            ...
            <a href="tel:0246923955"><i class="fas fa-phone"></i> (024) 6923955</a>
        </div>
        <div class="topbar-right">
            <a href="{{ route('login') }}" class="btn-admin-login"><i class="fas fa-sign-in-alt"></i> Login Admin</a>
        </div>
    </div>
</div>
    ...
    <div class="nav-inner">
        ...
        <ul class="nav-links">
            ...
            <li>
                ...
                <div class="dropdown">
                    <a href="{{ route('profil.struktur-organisasi') }}" class="dropdown-item"><i class="fas fa-sitemap"></i> Struktur Organisasi</a>
                    <a href="{{ route("profil.tupoksi") }}" class="dropdown-item"><i class="fas fa-tasks"></i> Tupoksi</a>
                    <a href="{{ route("profil.visi-misi") }}" class="dropdown-item"><i class="fas fa-eye"></i> Visi, Misi & Motto</a>
                    <a href="{{ route("profil.pejabat") }}" class="dropdown-item"><i class="fas fa-user-tie"></i> Profil Pejabat Struktural</a>
                </div>
            </li>
            ...
            <li>
                ...
                <div class="dropdown">
                    <a href="{{ route('ppid.index') }}" class="dropdown-item has-sub">
                        <i class="fas fa-file-alt"></i> Informasi Publik
                    </a>
                    <a href="{{ route('information.create') }}" class="dropdown-item"><i class="fas fa-clipboard-list"></i> Permohonan Informasi</a>
                    <a href="{{ route('information.flow') }}" class="dropdown-item"><i class="fas fa-route"></i> Alur Permohonan Informasi</a>
                    <a href="#" class="dropdown-item"><i class="fas fa-forward"></i> Rekap Permohonan Informasi</a>
                </div>
            </li>
            ...
            <li>
                ...
                <div class="dropdown">
                    <a href="{{ route("public.health-profiles") }}" class="dropdown-item"><i class="fas fa-book-medical"></i> Profil Kesehatan</a>
                    <a href="{{route('galery.public')}}" class="dropdown-item"><i class="fas fa-newspaper"></i> Media Kesehatan</a>
                    <a href="{{ route('produkhukum.index') }}" class="dropdown-item"><i class="fas fa-scale-balanced"></i> Produk Hukum</a>
                </div>
            </li>
            ...
            <li>
                ...
                <div class="dropdown">
                    <a href="{{ route('articles.public') }}" class="dropdown-item"><i class="fas fa-newspaper"></i> Artikel</a>
                    <a href="{{ route('announcements.index') }}" class="dropdown-item"><i class="fas fa-bullhorn"></i> Pengumuman</a>
                    <a href="{{ route('public.standar_pelayanan.index') }}" class="dropdown-item"><i class="fas fa-clipboard-check"></i> Standar Pelayanan</a>
                    <a href="#" class="dropdown-item"><i class="fas fa-poll"></i> Indeks Kepuasan Masyarakat</a>
                    <a href="https://eskm.kabsmg.id/" class="dropdown-item"><i class="fas fa-chart-bar"></i> Survei Kepuasan Masyarakat</a>
                </div>
            </li>
            ...
            <li>
                ...
                <div class="dropdown">
                    <a href="{{ route('public.complaints.track') }}" class="dropdown-item"><i class="fas fa-route"></i> Tracking Pengaduan</a>
                    <a href="{{ route('public.complaints.services') }}" class="dropdown-item"><i class="fas fa-headset"></i> Layanan Pengaduan</a>
                    <a href="{{ route('public.complaints.create') }}" class="dropdown-item"><i class="fas fa-pen-alt"></i> Form Pengaduan</a>
                    <a href="{{ route('public.reviews.index') }}" class="dropdown-item"><i class="fas fa-comment-alt"></i> Kritik & Saran</a>
...
<div class="mobile-nav" id="mobileNav">
    ...
    <div style="margin-top:1rem;">
        ...
        <a href="{{ route("profil.tupoksi") }}">Tupoksi</a>
        <a href="{{ route("profil.visi-misi") }}">Visi, Misi & Motto</a>
        <a href="{{ route("profil.pejabat") }}">Profil Pejabat Struktural</a>
        <div class="mobile-section-title">PPID</div>
        <a href="{{ route('ppid.index') }}">Informasi Publik</a>
        <a href="{{ route('information.create') }}">Permohonan Informasi</a>
        <a href="{{ route('information.flow') }}">Alur Permohonan Informasi</a>
        
        <div class="mobile-section-title">Media</div>
        <a href="{{ route("public.health-profiles") }}">Profil Kesehatan</a>
        <a href="#">Media Kesehatan</a>
        <a href="{{ route('produkhukum.index') }}">Produk Hukum</a>
        <div class="mobile-section-title">Informasi</div>
        <a href="{{ route('articles.public') }}">Artikel</a>
        <a href="{{ route('announcements.index') }}">Pengumuman</a>
        <a href="#">Standar Pelayanan</a>
        <div class="mobile-section-title">Pengaduan</div>
        <a href="{{ route('public.complaints.track') }}">Track Pengaduan</a>
        <a href="{{ route('public.complaints.services') }}">Layanan Pengaduan</a>
        <a href="{{ route('public.complaints.create') }}">Form Pengaduan</a>
        <a href="{{ route('public.reviews.index') }}">Kritik & Saran</a>
    </div>
</div>
    ...
    @if($heroImages->isNotEmpty())
        ...
        <div class="slide {{ $idx === 0 ? 'active' : '' }}" data-index="{{ $idx }}">
            ...
            <div class="slide-content">
                <div class="hero-badge"><i class="fas fa-circle"></i> Portal Resmi Dinas Kesehatan Kabupaten Semarang</div>
                <h1>{{ $img->title }}</h1>
                <p class="hero-sub">{{ $img->description }}</p>
                <div class="hero-actions">
                    <a href="{{ route('fasyankes.public') }}" class="btn-hero-primary"><i class="fas fa-hospital"></i> Lihat Fasyankes</a>
                </div>
            </div>
        </div>
    </div>
        @endforeach
    @else
        <!-- Fallback slide when no hero images in DB -->
    @endif
    <!-- Prev / Next arrows -->
...
<section class="stats-section">
    <div class="stats-container">
        <div class="stats-grid">
            <div class="stat-item">
                <div class="stat-item-icon"><i class="fas fa-hospital-alt"></i></div>
                <div><div class="stat-item-value">{{ $stats['klinik'] }}</div><div class="stat-item-label">Klinik</div></div>
            </div>
            <div class="stat-item">
                <div class="stat-item-icon"><i class="fas fa-clinic-medical"></i></div>
                <div><div class="stat-item-value">{{ $stats['rumah sakit'] }}</div><div class="stat-item-label">Rumah Sakit</div></div>
            </div>
            <div class="stat-item">
                <div class="stat-item-icon"><i class="fas fa-pills"></i></div>
                <div><div class="stat-item-value">{{ $stats['puskesmas'] }}</div><div class="stat-item-label">Puskesmas</div></div>
            </div>
            <div class="stat-item">
                <div class="stat-item-icon"><i class="fas fa-pills"></i></div>
                <div><div class="stat-item-value">{{ $stats['apotek'] }}</div><div class="stat-item-label">Apotek</div></div>
            </div>
            <div class="stat-item">
                <div class="stat-item-icon"><i class="fas fa-pills"></i></div>
                <div><div class="stat-item-value">{{ $stats['laboratorium'] }}</div><div class="stat-item-label">Laboratorium</div></div>
            </div>
            <div class="stat-item">
                <div class="stat-item-icon"><i class="fas fa-users"></i></div>
                <div><div class="stat-item-value">1.6M</div><div class="stat-item-label">Penduduk Dilayani</div></div>
            </div>
        </div>
    </div>
</section>
...
<section class="section" style="padding-top:3rem; padding-bottom:2rem;">
    <div class="container">
        <div class="quick-grid reveal">
            <a href="{{ route('fasyankes.public') }}" class="quick-card"><div class="quick-card-icon"><i class="fas fa-hospital"></i></div><span>Fasilitas Kesehatan</span></a>
            {{-- <a href="#" class="quick-card"><div class="quick-card-icon"><i class="fas fa-map-marked-alt"></i></div><span>Peta Kesehatan</span></a> --}}
            <a href="{{ route('ppid.index') }}" class="quick-card"><div class="quick-card-icon"><i class="fas fa-file-alt"></i></div><span>Informasi Publik</span></a>
            <a href="{{ route('articles.public') }}" class="quick-card"><div class="quick-card-icon"><i class="fas fa-newspaper"></i></div><span>Berita Terkini</span></a>
            <a href="{{ route('public.complaints.create') }}" class="quick-card"><div class="quick-card-icon"><i class="fas fa-pen-alt"></i></div><span>Pengaduan</span></a>
            <a href="{{ route('information.create') }}" class="quick-card"><div class="quick-card-icon"><i class="fas fa-clipboard-list"></i></div><span>Permohonan Informasi</span></a>
            <a href="{{ route("public.health-profiles") }}" class="quick-card"><div class="quick-card-icon"><i class="fas fa-book-medical"></i></div><span>Profil Kesehatan</span></a>
            <a href="{{ route('fasyankes.map') }}" class="quick-card"><div class="quick-card-icon"><i class="fas fa-poll"></i></div><span>Maps Fasyankes</span></a>
        </div>
    </div>
</section>
...
<section class="section section-alt" id="fasyankes">
    <div class="container">
        <div class="section-header reveal">
            ...
            <h2>Daftar Fasilitas Pelayanan Kesehatan</h2>
            <p>Temukan fasilitas pelayanan kesehatan terdekat di Kabupaten Semarang dengan informasi lengkap dan lokasi peta.</p>
        </div>
...
<footer class="footer">
    <div class="container">
        <div class="footer-grid">
            <div>
                ...
                <div style="margin-top:1rem;">
                    ...
                    <div class="footer-contact-item"> <a href="mailto:dinkeskabsemarang@gmail.com"><i class="fas fa-envelope"></i> <span class="__cf_email__" data-cfemail="2a4e4344414f596a5a4f4741455e04594f474b584b444d044d4504434e">dinkeskabsemarang@gmail.com</span></a></div>
            ...
            <div>
                <h4>Profil & PPID</h4>
                <ul>
                    <li><a href="{{ route('profil.struktur-organisasi') }}"><i class="fas fa-chevron-right"></i> Struktur Organisasi</a></li>
                    <li><a href="{{ route("profil.tupoksi") }}"><i class="fas fa-chevron-right"></i> Tupoksi</a></li>
                    <li><a href="{{ route("profil.visi-misi") }}"><i class="fas fa-chevron-right"></i> Visi, Misi & Motto</a></li>
                    <li><a href="{{ route('ppid.index') }}"><i class="fas fa-chevron-right"></i> Informasi Publik</a></li>
                    <li><a href="{{ route('information.create') }}"><i class="fas fa-chevron-right"></i> Permohonan Informasi</a></li>
            ...
            <div>
                <h4>Media & Info</h4>
                <ul>
                    <li><a href="{{ route('articles.public') }}"><i class="fas fa-chevron-right"></i> Artikel</a></li>
                    <li><a href="{{ route('announcements.index') }}"><i class="fas fa-chevron-right"></i> Pengumuman</a></li>
                    <li><a href="{{ route("public.health-profiles") }}"><i class="fas fa-chevron-right"></i> Profil Kesehatan</a></li>
                    <li><a href="{{ route('produkhukum.index') }}"><i class="fas fa-chevron-right"></i> Produk Hukum</a></li>
            ...
            <div>
                ...
                <ul>
                    <li><a href="{{ route('public.complaints.track') }}"><i class="fas fa-chevron-right"></i> Tracking Pengaduan</a></li>
                    <li><a href="{{ route('public.complaints.services') }}"><i class="fas fa-chevron-right"></i> Layanan Pengaduan</a></li>
                    <li><a href="{{ route('public.complaints.create') }}"><i class="fas fa-chevron-right"></i> Form Pengaduan</a></li>
                    <li><a href="{{ route('public.reviews.index') }}"><i class="fas fa-chevron-right"></i> Kritik & Saran</a></li>
        ...
        <div class="footer-bottom">
            <span>&copy; 2026 Dinas Kesehatan Kabupaten Semarang. V.01.26</span>
            <div class="footer-socials">
                <a href="https://www.facebook.com/people/Dinas-Kesehatan-Kabupaten-Semarang/100058213653293/"><i class="fab fa-facebook-f"></i></a>
                <a href="https://instagram.com/dinkes_kabsemarang"><i class="fab fa-instagram"></i></a>
                <a href="https://www.youtube.com/@dinaskesehatankabupatensem8730"><i class="fab fa-youtube"></i></a>
            </div>
        </div>
    </div>
</footer>
